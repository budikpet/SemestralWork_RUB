...
module Renamer
  ...
  class CLI < Thor
    ...
    method_option :replace_mode, type: :string, aliases: '-m', default: ReplaceModes::ALL, enum: ReplaceModes.all_values, desc: 'If this flag is set then all given folders will be renamed instead of their content.'
